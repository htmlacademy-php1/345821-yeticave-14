...
('Крепления Union Contact Pro 2015 года размер L/XL','крепление новое', 'img/lot-3.jpg', '8000','2022-05-30','500','2', '2', '1'),
('Ботинки для сноуборда DC Mutiny Charocal','боты удобные фиксируют стопу','img/lot-4.jpg','10999','2022-06-01','500','1','3', '2'),
('Куртка для сноуборда DC Mutiny Charocal','куртка класс','img/lot-5.jpg','7500','2022-05-29','500','1', '4', '2'),
('Маска Oakley Canopy','маска защищает от ветра и снега','img/lot-6.jpg','5400','2022-05-10','500','2','6','1');
...
GROUP BY l.id; --получить список открытых лотов

SELECT l.name, descriprion, img_link, start_price, end_date, bet_step, created_by, c.name
FROM lots l
